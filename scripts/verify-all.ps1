...
try {
    ...
    Assert-JsonInvariant `
        ...
        -Check { param($x) $x.status -eq 'PASS' -and $x.finding_count -eq 0 -and $x.skipped_large_file_count -eq 0 -and $x.decode_replacement_count -eq 0 -and $x.unsupported_file_count -eq 7 -and $x.unsupported_extensions.'.jpg' -eq 5 -and $x.unsupported_extensions.'.png' -eq 2 } `
